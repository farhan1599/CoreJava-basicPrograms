/*
 * This program reads two numbers as input and
 * checks whether second number divides the first number or not
 */
...
public class DividesOrNot {
	public static void main(String[] args) {
		...
		if (num1 >= num2) {
			...
			System.out.println(
					"The first number is not greater than or equal to the second number."
